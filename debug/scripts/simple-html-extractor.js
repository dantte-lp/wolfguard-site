...
/**
 * Simple HTML extractor - uses curl to fetch and save the HTML
 * Then opens it in a browser to view the rendered page
 */
...
console.log('🌐 Fetching page from:', SITE_URL);

// Create a temporary HTML file that will open the site in an iframe and extract HTML
...
<body>
  <div class="container">
    ...
    <div id="iframe-container">
      <iframe id="target-frame" src="${SITE_URL}"></iframe>
    </div>
...
// Save extractor HTML
const extractorPath = path.join(REPORTS_DIR, 'html-extractor.html');
fs.writeFileSync(extractorPath, extractorHTML, 'utf8');

console.log('✅ Created HTML extractor at:', extractorPath);
console.log('📝 Open this file in your browser to extract the HTML manually');
console.log('');
console.log('The extractor will:');
console.log('  1. Load the WolfGuard site in an iframe');
console.log('  2. Wait 3 seconds for React to hydrate');
console.log('  3. Auto-extract the full outerHTML');
console.log('  4. Display it and allow you to download/copy');
console.log('');
console.log('Alternative: Run this command in your browser console:');
