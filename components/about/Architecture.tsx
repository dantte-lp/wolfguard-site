          ...
          <div className="flex items-start gap-4 mb-6">
            ...
            <div>
              ...
              <p className="text-muted-foreground leading-relaxed">
                WolfGuard is built with a clean, modular architecture that separates concerns and
                enables independent development, testing, and optimization of each component.
              </p>
            </div>
          </div>
        ...
        <Card>
          <CardBody className="p-6">
            ...
            <ul className="space-y-2 text-sm text-muted-foreground">
              <li>
                • <strong className="text-foreground">Zero-copy networking:</strong> Minimized data
                copying
              </li>
              <li>
                • <strong className="text-foreground">Hardware acceleration:</strong> AES-NI, AVX
                support
              </li>
              <li>
                • <strong className="text-foreground">Efficient TLS:</strong> wolfSSL optimizations
              </li>
              <li>
                • <strong className="text-foreground">Low memory footprint:</strong> &lt;50MB
                typical usage
              </li>
            </ul>
          </CardBody>
      ...
      <Card className="mt-6">
        <CardBody className="p-8">
          ...
          <div className="space-y-4 text-muted-foreground leading-relaxed">
            <p>
              Every architectural decision in WolfGuard prioritizes security without compromising
              performance:
            </p>
            <ul className="space-y-2 pl-6">
              <li>
                <strong className="text-foreground">Memory Safety:</strong> Strict bounds checking,
                safe string handling, no unsafe operations
              </li>
              <li>
                <strong className="text-foreground">Privilege Separation:</strong> Worker processes
                drop privileges after initialization
              </li>
              <li>
                <strong className="text-foreground">Defense in Depth:</strong> Multiple layers of
                security validation (wolfSentry, protocol checks, input validation)
              </li>
              <li>
                <strong className="text-foreground">Secure Defaults:</strong> Strong cipher suites,
